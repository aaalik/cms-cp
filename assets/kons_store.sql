...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2018 at 03:19 AM
...
(2, 'SATU', 'satu', 123, '2018-03-03', 0, 'asd', 'dfg', 'fgh', 'xcv', '16300496_1348735431863816_5193151549802499072_o.jpg');
...
(1, 'asepjason@gmail.com', 'Asep Jason', '$2y$10$PlhV97vu1QI63PiCyk0jmutAGW13gNK7ssCtMSevoMlmySJp.y6Ie', 1, 1);
...
--
ALTER TABLE `tb_banner`
  MODIFY `id_banner` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
